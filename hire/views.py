...
@login_required
@customer_required
def review_new2(request,pk,Service_category_pk):
	ser = get_object_or_404(Service_category,service__pk=pk,pk =Service_category_pk)
	er = Page.objects.filter(service_main=pk,service_cat=Service_category_pk)
	res = get_object_or_404(Services,pk=pk)
	if request.method == 'POST':
...
def worker_page2(request,pk):
	ser = get_object_or_404(Service_category,pk=pk)
	return render(request,'worker_page.html',{'service':ser})
	
def increment2(request,pk,Service_category_pk):
	print("hi")
	ser = get_object_or_404(Service_category,service__pk=pk,pk =Service_category_pk)
	er = Page.objects.filter(service_main=pk,service_cat=Service_category_pk)
	res = get_object_or_404(Services,pk=pk)
...
@login_required
@customer_required
def review_new3(request,pk,Service_category_pk):
	ser = get_object_or_404(Service_category,service__pk=pk,pk =Service_category_pk)
	er = Page.objects.filter(service_main=pk,service_cat=Service_category_pk)
	res = get_object_or_404(Services,pk=pk)
	if request.method == 'POST':
...
def worker_page3(request,pk):
	ser = get_object_or_404(Service_category,pk=pk)
	return render(request,'worker_page.html',{'service':ser})
	
def increment3(request,pk,Service_category_pk):
	print("hi")
	ser = get_object_or_404(Service_category,service__pk=pk,pk =Service_category_pk)
	er = Page.objects.filter(service_main=pk,service_cat=Service_category_pk)
	res = get_object_or_404(Services,pk=pk)
